...
func NewRootCmd() *cobra.Command {
	...
	root.AddCommand(newConfigCmd(), newEnvCmd(), newSlugCmd(), newTicketCmd(), newUpdateCheckCmd(), newUpgradeCmd(), newLearningsLogCmd(), newLearningsSearchCmd(), newQAConfigCmd())
	return root
}
