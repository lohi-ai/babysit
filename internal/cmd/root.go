...
func NewRootCmd() *cobra.Command {
	...
	root.AddCommand(newConfigCmd(), newEnvCmd(), newSlugCmd(), newTicketCmd(), newUpdateCheckCmd(), newUpgradeCmd(), newLearningsLogCmd(), newLearningsSearchCmd(), newQAConfigCmd(), newCodexCompetitiveCmd(), newTelemetryLogCmd(), newAnalyticsCronCmd(), newSecretsCmd(), newDesignCmd(), newDashboardCmd(), newAutopilotCmd())
	return root
}
