...
| [agent.go](../../internal/agent/agent.go) | Harness profiles and worker-command rendering | Extend adapters; do not invent model IDs or duplicate spawning machinery |
